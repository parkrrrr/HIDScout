...
#include "DeviceVIDProperty.g.h"

namespace winrt::HIDScout::implementation
{
    struct DeviceVIDProperty : DeviceVIDPropertyT<DeviceVIDProperty>
    {
        DeviceVIDProperty() = default;
...
{
    struct DeviceVIDProperty : DeviceVIDPropertyT<DeviceVIDProperty, implementation::DeviceVIDProperty>
    {
    };
}

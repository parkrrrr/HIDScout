...
#include "DeviceProductProperty.g.h"

namespace winrt::HIDScout::implementation
{
    struct DeviceProductProperty : DeviceProductPropertyT<DeviceProductProperty>
    {
        DeviceProductProperty() = default;
...
{
    struct DeviceProductProperty : DeviceProductPropertyT<DeviceProductProperty, implementation::DeviceProductProperty>
    {
    };
}
